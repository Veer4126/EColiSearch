import gym
from c_elegans_env_v11 import CEMazeEnv1, CEMazeEnv2, TrainingStatsCallback, ModelAndMetricsCheckpointCallback # type: ignore
...
for attempt, trial_seed in enumerate(seeds, start=1):
    ...
    checkpoint_callback = ModelAndMetricsCheckpointCallback(
        ...
        stats_callback=callback,  # <-- this is the TrainingStatsCallback
        verbose=1
    )
    ...
    # Save model
    model_filename = f"RL_models/trial{trial_number}_atmp{trial_seed}_sac_2_5M" # 2.5 M or 600K
