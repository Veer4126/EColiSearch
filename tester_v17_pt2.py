import gym
from c_elegans_env_v17 import CEMazeEnv, TrainingStatsCallback, ModelAndMetricsCheckpointCallback # type: ignore
...
for attempt, trial_seed in enumerate(seeds, start=1):
    ...
    model.learn(total_timesteps=10_000_000, callback=combined_callback)
