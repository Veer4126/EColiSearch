# Sparse reward, with VARYING chemical gradient. State vector [curr_conc, prev_conc, prev_p_w2r, prev_p_r2w].
...
class CEMazeEnv2(gym.Env):
    ...
    def __init__(self, size=10, max_steps=500, p_w2r=0.5, p_r2w=0.5, alpha=0.5, gradient_sigma=1.0):
        super().__init__()
        ...
        # [prev_conc, curr_conc, prev_p_w2r, prev_p_r2w]
    ...
    def reset(self, seed=None, options=None):
        ...
        # Randomize amplitude for each episode
        self.peak_amplitude = np.random.uniform(0.5, 20.0)
