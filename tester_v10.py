import gym
from c_elegans_env_v10 import CEMazeEnv1, CEMazeEnv2, TrainingStatsCallback, ModelAndMetricsCheckpointCallback # type: ignore
...
for attempt, trial_seed in enumerate(seeds, start=1):
    ...
    model = SAC(
        ...
        verbose=1,
        learning_rate=3e-4,
        buffer_size=150_000, # 150K for 500K iterations
