...
class CEMazeEnv1(gym.Env):
    ...
    def __init__(self, size=8, max_steps=2500, k_w2r=0.5, k_r2w=0.5, alpha=0.1, gradient_sigma=2.0):
        super().__init__()
        ...
        # [curr_conc, prev_p_reorient, prev_p_walk]
    ...
    def step(self, action=None):
        ...
        # These are 2 of the 3 components of the state vector
...
class CEMazeEnv2(gym.Env):
    ...
    def __init__(self, size=8, max_steps=500, k_w2r=0.5, k_r2w=0.5, alpha=0.5, gradient_sigma=2.0):
        super().__init__()
